...
<head>
    ...
    <?php if (getenv('APPLICATION_NAME')): ?>
        <link rel="shortcut icon" href="public/img/logo-kapille-sorvetes-site-rio-preto-103x103.png"/>
    <?php else: ?>
        <link rel="shortcut icon" href="public/img/logo-kapille-sorvetes-site-rio-preto-103x103.png"/>
    <?php endif; ?>
        ...
        <div class="logo">
          ...
          <span style="color:#ffff;">&nbsp;&nbsp;&nbsp;
            ...
            <?php else: ?>
                ...
                <img src="public/img/logo-kapille-sorvetes-site-rio-preto-103x103.png">
            <?php endif; ?>
